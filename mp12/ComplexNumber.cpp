...
ComplexNumber ComplexNumber::operator + (const ComplexNumber& arg)
{
    ...
    double imaginary = imaginary_component + arg.get_imaginary_component();
...
ComplexNumber ComplexNumber::operator / (const ComplexNumber& arg)
{
    ...
    double c = imaginary_component;
    double d = arg.get_imaginary_component();
    double x = b*b + d*d;
    return ComplexNumber((a*b+c*d)/x, (c*b-a*d)/x);
}
...
{
    /* Your code here */
	return ComplexNumber(-1*arg.get_imaginary_component()*imaginary_component, arg.get_imaginary_component()*real_component);
}
...
ComplexNumber ComplexNumber::operator / (const ImaginaryNumber& arg)
{
    ...
    double a = real_component;
    double b = imaginary_component;
    double x = arg.get_imaginary_component();
    return ComplexNumber(b/x,(-1*a)/x);
}
